        ...
        <div className="grid h-16 items-center grid-cols-[auto_1fr_auto] md:grid-cols-[1fr_auto_1fr]">
          ...
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            <div className="min-w-0 flex flex-col">
              <h1 className="truncate text-[0.875rem] font-semibold tracking-tight text-slate-800 sm:max-w-none max-w-[160px] leading-tight">
                纯金经典翻译计划
              </h1>
              <p className="truncate text-[0.75rem] text-slate-400 sm:max-w-none max-w-[180px] -mt-0.5">
                志愿者管理网站
              </p>
            </div>
          </div>
