...
const serviceBlueprints = [
  ...
  { volunteerId: 'PG-0001', volunteerName: '张三', serviceDate: '2026-01-18', serviceType: '管理', duration: 2.0, description: '新人术语规范培训' },
  { volunteerId: 'PG-0002', volunteerName: '李四', serviceDate: '2026-01-10', serviceType: '校对', duration: 2.5, description: '双语文档校对与一致性检查' },
  { volunteerId: 'PG-0002', volunteerName: '李四', serviceDate: '2026-02-02', serviceType: '管理', duration: 3.0, description: '项目流程培训支持' },
  { volunteerId: 'PG-0003', volunteerName: '王五', serviceDate: '2026-01-14', serviceType: '翻译', duration: 2.0, description: '活动海报繁体中文翻译' },
  { volunteerId: 'PG-0003', volunteerName: '王五', serviceDate: '2026-02-11', serviceType: '技术', duration: 1.5, description: '质量控制规范受训' },
  { volunteerId: 'PG-0004', volunteerName: '赵六', serviceDate: '2026-01-20', serviceType: '管理', duration: 2.5, description: '志愿者系统操作培训' },
  { volunteerId: 'PG-0004', volunteerName: '赵六', serviceDate: '2026-02-03', serviceType: '管理', duration: 2.0, description: '跨区域协作交流培训' },
  ...
  { volunteerId: 'PG-0007', volunteerName: '陈晨', serviceDate: '2026-02-12', serviceType: '管理', duration: 2.5, description: '数据录入流程培训' },
  { volunteerId: 'PG-0007', volunteerName: '陈晨', serviceDate: '2026-02-20', serviceType: '技术', duration: 1.5, description: '审核规范专项受训' },
  { volunteerId: 'PG-0008', volunteerName: '刘洋', serviceDate: '2026-01-22', serviceType: '翻译', duration: 2.0, description: '社区公告中英互译' },
  { volunteerId: 'PG-0008', volunteerName: '刘洋', serviceDate: '2026-02-16', serviceType: '管理', duration: 2.0, description: '社区活动组织培训' },
  { volunteerId: 'PG-0009', volunteerName: '黄敏', serviceDate: '2026-02-05', serviceType: '校对', duration: 1.5, description: '活动内容本地化校对' },
  { volunteerId: 'PG-0009', volunteerName: '黄敏', serviceDate: '2026-02-21', serviceType: '管理', duration: 2.5, description: '多地区协作项目培训' },
  { volunteerId: 'PG-0010', volunteerName: '林雪', serviceDate: '2026-01-25', serviceType: '翻译', duration: 3.0, description: '北美项目资料翻译支持' },
  { volunteerId: 'PG-0010', volunteerName: '林雪', serviceDate: '2026-02-14', serviceType: '管理', duration: 2.0, description: '志愿者沟通技巧培训' },
  { volunteerId: 'PG-0011', volunteerName: '谢鹏', serviceDate: '2026-01-28', serviceType: '技术', duration: 1.5, description: '平台新功能受训' },
  { volunteerId: 'PG-0011', volunteerName: '谢鹏', serviceDate: '2026-02-18', serviceType: '管理', duration: 2.5, description: '技术志愿者项目流程培训' },
  { volunteerId: 'PG-0012', volunteerName: '吴婷', serviceDate: '2026-02-09', serviceType: '校对', duration: 2.0, description: '繁体文案质量校对' },
  { volunteerId: 'PG-0012', volunteerName: '吴婷', serviceDate: '2026-02-24', serviceType: '管理', duration: 2.5, description: '活动执行项目培训' }
];
