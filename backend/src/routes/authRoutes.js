...
// 账号管理：v3.8 admin(全局) + 部长(本部门)。
// v3.8.1: 删除也对部长开放 —— 限本部门的 user/录入员，service 层 assertDeptScope 兜底。
...
router.delete('/admin/accounts/:accountId', authenticate, authorizeRoles('admin', 'a_admin'), AdminController.deleteAccount);
